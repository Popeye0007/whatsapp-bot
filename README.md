...
1. Deploy on Heroku
   ...
   - [FORK](https://github.com/Popeye0007/whatsapp-bot/fork) this repository.
   - Now [DEPLOY]([![Deploy To Heroku](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Popeye0007/whatsapp-bot).

2. Deploy on Koyeb
   - Create an account on [Koyeb](https://app.koyeb.com/auth/signup). [Sign up now](https://app.koyeb.com/auth/signup).
   - Get [DATABASE_URL](https://github.com/Popeye0007/whatsapp-bot/wiki/DATABASE_URL). You'll need this while deploying.
   ...
   - Enter [Environment Variables](https://github.com/Popeye0007/whatsapp-bot/wiki/Environment_Variables). [Read More](https://github.com/Popeye0007/whatsapp-bot/wiki/Environment_Variables).
...
3. Deploy on VPS or PC (Example here as in Ubuntu)
   ...
   - Install without a script
       ...
       - Clone the repository and install packages:
             ...
             git clone https://github.com/Popeye0007/whatsapp-bot botName
              cd botName
    ...
    - [Read More](https://github.com/Popeye0007/whatsapp-bot/wiki/Environment_Variables)
...
- [@adiwajshing](https://github.com/adiwajshing) for [Baileys](https://github.com/adiwajshing/Baileys)# whatsapp-bot
